    ...
    public class StandardStashView : MonoBehaviour, IVariableInventoryView
    {
        ...
        public virtual bool OnDrop(IVariableInventoryCell stareCell, IVariableInventoryCell effectCell)
        {
            ...
            if (!StashData.CheckInsert(index.Value, effectCell.CellData))
            {
                ...
                if (stareCell.CellData != null && stareCell.CellData is VariableInventorySystem.IStandardCaseCellData caseData)
                {
                    ...
                    if (id.HasValue)
                    {
                        effectCell.CellData.Id = id.Value;
            ...
            // place
            if (itemViews[index.Value].CellData != null)
            {
                if (itemViews[index.Value].CellData.IsStackable && effectCell.CellData.IsStackable && itemViews[index.Value].CellData.type == effectCell.CellData.type)
                {
                    if (itemViews[index.Value].CellData.currentAmount + effectCell.CellData.currentAmount <= itemViews[index.Value].CellData.maxAmount)
                    {
                        itemViews[index.Value].CellData.currentAmount += effectCell.CellData.currentAmount;
                        effectCell.CellData.Id = index.Value;
                    ...
                    {
                        effectCell.CellData.currentAmount -= itemViews[index.Value].CellData.maxAmount - itemViews[index.Value].CellData.currentAmount;
                        itemViews[index.Value].CellData.currentAmount = itemViews[index.Value].CellData.maxAmount;
                        return true;
                    }
                }
                else
        ...
        public virtual void OnDroped(bool isDroped)
        {
            ...
            if (!isDroped && originalId.HasValue)
            {
                ...
                originalCellData.Id = originalId.Value;
