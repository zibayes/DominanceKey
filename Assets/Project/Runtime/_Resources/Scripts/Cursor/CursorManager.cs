...
namespace VariableCode.Cursor
{
    ...
    public class CursorManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // timeDelay = GetTimeDelay(currentId);
        ...
        /// <summary>
        /// Returns the time delay before playing new iteration of animation
        /// </summary>
        /// <param name="cursorId"></param>
        /// <ret
        public float GetTimeDelay(CursorId cursorId)
        {
            timeDelay = 1;
            if (IsValidId(cursorId))
            {
                if (cursorId.referenceType == CursorReferenceType.Class)
                {
                    timeDelay = data[cursorId.classIndex].timeDelay;
                }
                else
                {
                    timeDelay = objects[cursorId.objectIndex].data[cursorId.classIndex].timeDelay;
                }
            }
